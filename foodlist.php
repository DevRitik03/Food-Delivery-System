    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          ?>
          <img class="img-profile rounded-circle" src="uploads/<?php echo $row['profile']; ?>"
...
?>
 ...
 <div class="jumbotron text-center bg-white">
   <h1>Welcome To Food Zone <i class="fas fa-utensils"></i></h1>
 </div>
 <!--jumbotron code-->
      ...
      ?>
       ...
       <div class="col-md-3 pb-3">
        ...
        <form method="POST" action="inc/cartcheck.inc.php?fid=<?php echo $row['fid']; ?>">
         <div class="card">
           <img class="card-img-top img-fluid" style="height:300px; border-radius: 20px;" src="uploads/<?php echo $row['fimage']; ?>" alt="foodimage">
