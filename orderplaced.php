...
<html>
<head>
	<title>Food Zone Order Details</title>
  <meta charset="utf-8">
    ...
    <div class="container">
    	<div align="center" class="mt-5">
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-12">
    				<button type="button" data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-lg btn-success"><i class="fas fa-info-circle"></i> See Order Details</button>&nbsp;&nbsp;
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered" role="dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterLabel">Your Current Order Detail</h5>
...
<!-- Modal Tracking 2-->
<div class="modal fade" id="trackingmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
