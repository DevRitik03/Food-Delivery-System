...
<br>
   <h1 class="text-center mb-5">
     ...
     <a   class="btn btn-success btn-lg text-white" data-toggle="modal" data-target="#exampleModalCenter">
<i class="far fa-money-bill-alt"></i> Cash On Delivery
  </a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Order has been placed successfully</h5>
      ...
      <div class="modal-footer">
        <a href="inc/cod.inc.php" class="btn btn-primary">view more</a>
      </div>
    </div>
  </div>
</div>
