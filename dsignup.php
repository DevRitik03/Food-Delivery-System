...
<div class="jumbotron" style="background: rgba(0, 0, 0, 0.6); margin-bottom: 0px;">
	<h1 class="text-white">Want to become a Rider!</h1>
   ...
   <div class="container">
      ...
      ?>
		...
		<h3 class="text-center"> Create Account</h3>
      	...
      	<div>
      		<label class="text-white">Blood Group</label>
        ...
        <div class="form-group">
      	 <label class="text-white">Driving License Number</label>
        ...
        <div class="form-group">
        	<label class="text-white">Upload your Photo</label>
