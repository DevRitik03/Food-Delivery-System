...
?>
     ...
     <!--Landing-->
     <div id="home">
     	<div class="landingtxt" style="background: rgba(0, 0, 0, 0.6); margin-bottom: 20px;>
       <div class="jumbotron" style="background: rgba(0, 0, 0, 0.6); margin-bottom: 20px;">
     ...
     <!--end grid-->
      ...
      <!--contact-->
      <div id="contact">
      <div class="" style="background: rgba(0, 0, 0, 0.6); margin-bottom: 0px;">
      <br>
      <br>
      	<div class="con text-center  text-white">
      		Contact Us
          </div>
      	</div>
        <div class="jumbotron" style="background: rgba(0, 0, 0, 0.6); margin-bottom: 0px;">
      	<div class="contact">
      		<form onsubmit="alert("done")" action="https://formsubmit.io/send/60595ee1-9908-4251-886a-7f1c3d53e6fe" method="POST" id="my-form>
          <legend style="border-radius: 15px;background-color: black;
        color: black; font-size: 15px; font-weight: 400; margin: 0 auto;" class="pl-4 pr-4 pb-4 pt-1 text-white" >
      			<div class="form-group">
      				<label class="text-white"><br>Username<br></label>
      				<input type="text" name="name" autocomplete="off" class="form-control">
              <input name="_redirect" type="hidden" id="redirect" value="http://localhost/ffc/thanks.html">
      			</div>
      			<div class="form-group">
      				<label class="text-white">Email Id<br></label>
      				<input type="text" name="email" autocomplete="off" class="form-control">
      			</div>
      			<div class="form-group">
      				<label class="text-white">Text<br></label>
